      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6 animate-fade-in">
          ...
          <p className="text-lg text-gray-700 max-w-md">
            Introducing Aromix: Smart automated perfume dispensing machines for public spaces. Experience luxury fragrances anywhere, anytime, at an affordable price.
          </p>
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-6 -right-6 h-28 w-28 md:h-36 md:w-36 bg-perfume-peach rounded-full flex items-center justify-center shadow-lg animate-pulse-gentle">
            <div className="text-center">
              <p className="font-bold text-xl md:text-2xl text-perfume-darkPurple">$0.50</p>
